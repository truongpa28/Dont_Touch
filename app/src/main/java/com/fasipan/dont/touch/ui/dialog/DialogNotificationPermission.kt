...
import com.fasipan.dont.touch.databinding.DialogNotificationPermissionBinding
import com.fasipan.dont.touch.utils.ex.setOnTouchScale

class DialogNotificationPermission(
    private val context: Context
) {
    private val binding by lazy {
        DialogNotificationPermissionBinding.inflate(LayoutInflater.from(context))
    }
